    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제3조 약관의 효력 및 변경</h2>
            <p className={styles.text}>
            ...
            <p className={styles.text}>
              3. 변경된 약관은 공지된 시행일로부터 효력이 발생합니다.
            </p>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제4조 서비스의 제공 및 변경</h2>
            <p className={styles.text}>
              1. 회사는 다음과 같은 서비스를 제공합니다:
            </p>
            <ul className={styles.list}>
              <li className={styles.listItem}>
                타인이 작성한 자신에 대한 오브제 조회 기능
              </li>
              <li className={styles.listItem}>
                타인에게 오브제를 작성해달라고 요청하는 기능
              </li>
              <li className={styles.listItem}>
                라운지에서 오브제를 조회하고 소통하는 기능
              </li>
              <li className={styles.listItem}>라운지 생성 및 관리 기능</li>
              <li className={styles.listItem}>
                오브제에 대한 피드백 작성/수정/삭제 기능
              </li>
              <li className={styles.listItem}>마이룸 설정 및 이용 기능</li>
              <li className={styles.listItem}>
                음성통화 및 실시간 채팅 기능(WebRTC)
              </li>
              <li className={styles.listItem}>
                OAuth를 통한 로그인 및 유저 인증 기능
              </li>
            </ul>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제5조 서비스 이용</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제6조 이용자 계정</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제7조 이용자의 의무</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제8조 개인정보 보호</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제9조 서비스 이용제한</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제10조 책임제한</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>제11조 준거법 및 재판관할</h2>
            <p className={styles.text}>
          ...
          <div className={styles.section}>
            <h2 className={styles.subTitle}>부칙</h2>
            <p className={styles.text}>
              본 약관은 2024년 7월 28일부터 시행됩니다.
            </p>
          </div>
        </div>
      </div>
